...
% Output Frequency 
IN.tOut = '0.1 kyr'; % Results (IN.tMult times slower w/ no res)
IN.tMult = 100;

IN.tOut2 = '0.1 kyr'; % Results (IN.tMult times slower w/ no res)
IN.tMult2 = 100;
...
% 17 = Pure Water
IN.simu   = 17;       % Simulation number (see above)
